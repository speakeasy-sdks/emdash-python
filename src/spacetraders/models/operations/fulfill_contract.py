...
class FulfillContract200ApplicationJSON:
    r"""OK"""
    data: FulfillContract200ApplicationJSONData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
...
class FulfillContractResponse:
    ...
    fulfill_contract_200_application_json_object: Optional[FulfillContract200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""
